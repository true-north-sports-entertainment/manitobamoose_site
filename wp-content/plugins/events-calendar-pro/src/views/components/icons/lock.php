 ...
 * [your-theme]/tribe/events/v2/components/icons/lock.php
 *
...
$svg_classes = [ 'tribe-common-c-svgicon', 'tribe-common-c-svgicon--lock' ];

if ( ! empty( $classes ) ) {
	$svg_classes = array_merge( $svg_classes, $classes );
}
?>
<svg <?php tribe_classes( $svg_classes ); ?> xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330" xml:space="preserve">
