...
<nav class="navbar navbar-expand-lg navbar-light bg-light position-relative py-3 py-sm-3 px-4 px-sm-5">
        <div class="container-fluid p-0">
                <a class="navbar-brand d-none d-lg-inline-flex" href="<?php echo get_site_url(); ?>/">
                    <picture>
                        <source srcset="<?php bloginfo('url');?>/wp-content/themes/burt/images/bct-hz-logo.svg" media="(min-width: 1500px)" />
                        <source srcset="<?php bloginfo('url');?>/wp-content/themes/burt/images/bct-frame-logo.svg" media="(min-width: 992px)" />
                        <source srcset="<?php bloginfo('url');?>/wp-content/themes/burt/images/bct-hz-logo.svg" media="(min-width: 750px)" />
                        <source srcset="<?php bloginfo('url');?>/wp-content/themes/burt/images/bct-frame-logo.svg"/>
                        <img src="<?php bloginfo('url');?>/wp-content/themes/burt/images/bct-frame-logo.svg" alt="Logo of the Burton Cummings Theatre featuring bold blue text on a white background, with a greem decorative design above the name."/>
                    </picture>   
                    <div id="snce"><img src="<?php bloginfo('url');?>/wp-content/themes/burt/images/laurel-comm.svg" alt=""/></div>            
                </a>
                ...
                <div id="options-rgt">
                    <div id="search-box">
                        <!-- Search Button -->
                        <img id="searchIcon" src="<?php bloginfo('url'); ?>/wp-content/themes/burt/images/search-icon.svg" alt="Magnifying glass icon for Search">
                    ...
                    <div id="calendar-bu" class="ms-1 ps-1">
                        <a href="/events/month"><img src="<?php bloginfo('url')?>/wp-content/themes/burt/images/cal-icon.svg" alt="Calendar icon for Upcoming Events in Month view"></a>
                    </div>
