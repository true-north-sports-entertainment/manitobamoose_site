...
$time_format = tribe_get_time_format(); // Use WordPress time format settings
$event_time = $event->dates->start->format( 'g:i A' ); // Example: 8:00 PM
?>
...
<div class="tribe-events-calendar-month-mobile-events__mobile-event-datetime tribe-common-b2">
	...
	<?php else : ?>
		<time datetime="<?php echo esc_attr( $event->dates->start->format( Dates::DBTIMEFORMAT ) ); ?>">
