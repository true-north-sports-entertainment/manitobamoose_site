...
<div class="row">
	<div class="col-12">
		<p class="tribe-events-back">
			<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'View All %s', '%s Events plural label', 'the-events-calendar' ), $events_label_plural ); ?></a>
		</p>
		<!-- Notices -->
...
<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 col-xxl-7">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="px-0 px-lg-4"><?php do_action( 'tribe_events_single_event_after_the_content' ) ?></div>
		...
		<div id="tribe-events-footer">
			...
			<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'the-events-calendar' ), $events_label_singular ); ?>">
				<ul class="tribe-events-sub-nav">
					<li class="tribe-events-nav-previous"><?php tribe_the_prev_event_link( '<span>&laquo;</span> <span class="title-label">Previous/span>' ) ?></li>
					<li class="tribe-events-nav-next"><?php tribe_the_next_event_link( '<span class="title-label">Next</span> <span>&raquo;</span>' ) ?></li>
				</ul>
